...
public class BazarZoneDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        BazarZoneGlobalFeatureConfigurator.Configure();
        BazarZoneModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.Resources
                .Add<BazarZoneResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/BazarZone");

            options.DefaultResourceType = typeof(BazarZoneResource);
        ...
        {
            options.MapCodeNamespace("BazarZone", typeof(BazarZoneResource));
        });
    }
}
