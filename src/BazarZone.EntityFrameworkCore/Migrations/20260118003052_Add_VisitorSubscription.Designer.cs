...
namespace BazarZone.Migrations
{
    ...
    [Migration("20260118003052_Add_VisitorSubscription")]
    partial class Add_VisitorSubscription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BazarZone.Contact.ContactRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppContactRequests", (string)null);
                });

            modelBuilder.Entity("BazarZone.Content.PageContent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppPageContents", (string)null);
                });

            modelBuilder.Entity("BazarZone.Media.AppImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAppImages", (string)null);
                });

            modelBuilder.Entity("BazarZone.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BazarZone.ServiceProviders.ProviderApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppProviderApplications", (string)null);
                });

            modelBuilder.Entity("BazarZone.ServiceProviders.ServiceProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppServiceProviders", (string)null);
                });

            modelBuilder.Entity("BazarZone.Services.Service", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BazarZone.Sliders.SliderBanner", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSliderBanners", (string)null);
                });

            modelBuilder.Entity("BazarZone.Visitors.VisitLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppVisitLogs", (string)null);
                });

            modelBuilder.Entity("BazarZone.Visitors.VisitorSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppVisitorSubscriptions", (string)null);
                });
